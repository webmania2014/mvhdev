        ...
        <div class="col-md-7 col-xs-12 col-form col-st">                        
            <div class="panel panel-sky">
                ...
                <div class="panel-body collapse in">
                    ...
                    <form action="<?php echo base_url();?>works/process" class="form-horizontal row-border" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2">
                                <div class="btn-toolbar">
                                    <button class="btn-primary btn" name="action" value="Save work" onclick="javascript:$('#validate-form').parsley( 'validate' );">Start work</button>
