<div class="container">
    ...
    <div class="row">
        <ul class="nav nav-tabs" style="font-size:16px">
          <li id="follow-up-btn" onclick="changeTab('follow-up',event)" role="presentation" class="active"><a href="#">Follow up search</a></li>
        </ul>
        <div id="follow-up-search" style="padding:20px;border-left-style: solid; border-width: 1px;border-color: #DDDDDD;">
            ...
            <form class="form-inline col-xs-1"> 
                <input class="form-control" type="checkbox" style="display:inline;width:0px">
                <label class="control-label" style="display:inline"> <b>Status: </b></label>
            </form>
            <form class="form-inline col-xs-2"> 
                <input class="form-control" type="checkbox" id="not_sent_check" style="display:inline">
                <label for="not_sent_check" class="control-label">Not sent</label>
            </form>
            <form class="form-inline col-xs-2"> 
                <input class="form-control" type="checkbox" id="sent_check" style="display:inline">
                <label for="sent_check" class="control-label">Sent</label>
            </form>
            <form class="form-inline col-xs-2"> 
                <input class="form-control" type="checkbox" id="accepted_check" style="display:inline">
                <label for="accepted_check" class="control-label">Accepted </label>
            </form>
            <form class="form-inline col-xs-2"> 
                <input class="form-control" type="checkbox" id="invoiced_check" style="display:inline">
                <label for="invoiced_check" class="control-label">Invoiced</label>
            </form>
...
<script>
    ...
    function get_scaffold(){
        ...
        console.log('text');
        console.log(text);
        var url = "<?php echo base_url(); ?>followup/search_followup?client_id="+text;
        $.ajax({
          type: "GET",
          url: url, 
          dataType: "text",  
