    ...
    <div id="page-container">
        ...
        <nav id="page-leftbar" role="navigation">
            ...
            <ul class="acc-menu" id="sidebar">
                ...
                <li><a href="javascript:;"><i class="fa fa-th"></i> <span>Work</span> </a>
                    <ul class="acc-menu">
                ...
                <li><a href="javascript:;"><i class="fa fa-list-ol"></i> <span>Offers</span> <span class="badge badge-indigo">4</span></a>
                    <ul class='acc-menu'>
                ...
                <li><a href="javascript:;"><i class="fa fa-tasks"></i> <span>Projects</span> <span class="badge badge-info">12</span></a>
                    <ul class="acc-menu">
                ...
                <li><a href="javascript:;"><i class="fa fa-table"></i> <span>Acceptance</span></a>
                    <ul class="acc-menu">
                ...
                <li><a href="javascript:;"><i class="fa fa-bar-chart-o"></i> <span>Reports</span><span class="badge badge-primary">5</span></a>
                    <ul class="acc-menu">
                ...
                <li><a href="javascript:;"><i class="fa fa-map-marker"></i> <span>Follow up</span></a>
                    <ul class="acc-menu">
                        <li><a href="maps-google.php">Google Maps</a></li>
                        <li><a href="maps-vector.php">Vector Maps</a></li>
                    </ul>
                </li>
                <li><a href="javascript:;"><i class="fa fa-sitemap"></i> <span>Clients</span></a>
                    <ul class="acc-menu">
                        <li><a href="<?php echo base_url(); ?>clients/create">Create Client</a></li>
                        <li><a href="<?php echo base_url(); ?>clients">Overviews</a></li>
                    </ul>
                </li>
                <li><a href="calendar.php"><i class="fa fa-calendar"></i> <span>Subcontractors</span></a></li>
                
                <li><a href="javascript:;"><i class="fa fa-user"></i> <span>Workers</span></a>
                    <ul class="acc-menu">
                        <li><a href="<?php echo base_url(); ?>workers/create">Create Worker</a></li>
                        <li><a href="<?php echo base_url(); ?>workers">Overviews</a></li>
                    </ul>
                </li>

                <li><a href="javascript:;"><i class="fa fa-briefcase"></i> <span>Managment</span> <span class="badge badge-orange">2</span></a>
                    <ul class="acc-menu">
