...
<head>
	<meta charset="utf-8">
	<title><?php echo $this->logtrino_ui->_get_title(); ?></title>
	...
	<?php if (isset($_COOKIE["theme"])) {
	    echo "<link href='".base_url()."/assets/demo/variations/". $_COOKIE["theme"] ."' rel='stylesheet' type='text/css' media='all' id='styleswitcher'>";
	} else { ?> 
    ...
    <?php if (isset($_COOKIE["headerstyle"])) {
        echo "<link href='".base_url()."/assets/demo/variations/". $_COOKIE["headerstyle"] ."' rel='stylesheet' type='text/css' media='all' id='headerswitcher'>";
    } else { ?>
...
if ($pageName == "maps-vector.php") {
    ...
    linktag(base_url().'/assets/plugins/jqvmap/jqvmap.css'); // <!-- jQuery vector maps -->
 } elseif ($pageName == "icons-glyphicons.php") {   
    linktag(base_url().'assets/fonts/glyphicons/css/glyphicons.min.css'); // <!-- glyphicons -->
} elseif ($pageName == "form-components.php") {   
    linktag(base_url().'assets/plugins/form-select2/select2.css'); //<!-- Select2 -->
    linktag(base_url().'assets/plugins/form-multiselect/css/multi-select.css'); //<!-- Multiselect -->
    linktag(base_url().'assets/plugins/jqueryui-timepicker/jquery.ui.timepicker.css'); //<!-- jq UI Timepicker -->
    linktag(base_url().'assets/plugins/form-daterangepicker/daterangepicker-bs3.css'); //<!-- DateRangePicker -->
    linktag(base_url().'assets/plugins/form-fseditor/fseditor.css'); //<!-- FullScreen Editor -->
    linktag(base_url().'assets/plugins/form-tokenfield/bootstrap-tokenfield.css'); //<!-- Tokenfield -->
    linktag(base_url().'assets/js/jqueryui.css'); // <!-- jquery ui -->
} elseif ($pageName == "ui-paginations.php") {
    linktag(base_url().'assets/plugins/datepaginator/bootstrap-datepaginator.css');
} elseif ($pageName == "charts-svg.php") {
    linktag(base_url().'assets/plugins/charts-morrisjs/morris.css'); //> <!-- Charts -->
} elseif ($pageName == "form-fileupload.php") {
	linktag(base_url().'assets/plugins/jquery-fileupload/css/jquery.fileupload-ui.css'); // <!--File Upload-->
} elseif ($pageName == "form-dropzone.php") {
    linktag(base_url().'assets/plugins/dropzone/css/dropzone.css'); //<!-- Dropzone-->
} elseif ($pageName == "ui-tour.php") {
    linktag(base_url().'assets/plugins/bootstro.js/bootstro.min.css'); //<!-- Bootstro.js-->
} elseif ($pageName == "ui-sliders.php") {
    linktag(base_url().'assets/plugins/progress-skylo/skylo.css'); // <!-- Sky Loader Progress Bar -->
    linktag(base_url().'assets/js/jqueryui.css'); // <!-- jquery ui -->
} elseif ($pageName == "form-imagecrop.php") {
    linktag(base_url().'assets/plugins/jcrop/css/jquery.Jcrop.min.css'); // <!-- jCrop -->
} elseif ($pageName == "index.php") {
    linktag(base_url().'assets/plugins/form-daterangepicker/daterangepicker-bs3.css'); //<!-- DateRangePicker -->
    linktag(base_url().'assets/plugins/fullcalendar/fullcalendar.css'); // <!-- Calendar -->
    linktag(base_url().'assets/plugins/form-markdown/css/bootstrap-markdown.min.css');
} elseif ($pageName == "calendar.php") {
    linktag(base_url().'assets/plugins/fullcalendar/fullcalendar.css'); // <!-- Calendar -->
} elseif ($pageName == "ui-nestable.php") {
    linktag(base_url().'assets/plugins/form-nestable/jquery.nestable.css'); //<!-- Nestable Lists-->
} elseif ($pageName == "tables-data.php") {
    linktag(base_url().'assets/plugins/datatables/dataTables.css'); // <!-- Data Tables -->
} elseif ($pageName == "tables-editable.php") {
    linktag(base_url().'assets/plugins/datatables/dataTables.css'); // <!-- Data Tables -->
} elseif ($pageName == "form-xeditable.php") {
    linktag(base_url().'assets/plugins/form-xeditable/bootstrap3-editable/css/bootstrap-editable.css'); // <!-- X-Editable -->
} elseif ($pageName == "ui-alerts.php") {
    linktag(base_url().'assets/plugins/pines-notify/jquery.pnotify.default.css');
}
    linktag(base_url().'assets/plugins/codeprettifier/prettify.css'); // <!-- Google Code Prettifier -->
    linktag(base_url().'assets/plugins/form-toggle/toggles.css'); //<!-- Toggles -->
?>
        		...
        		<ul class="dropdown-menu userinfo arrow">
        			...
        			<li class="userlinks">
        				<ul class="dropdown-menu">
        					...
        					<li class="divider"></li>
        					<li><a href="<?php echo base_url() ?>auth/logout" class="text-right">Sign Out</a></li>
        				</ul>
        			</li>
        		</ul>
        	</li>
    ...
    <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse" id="horizontal-navbar">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle='dropdown'><i class="fa fa-th"></i> <span>Works<i class="fa fa-angle-down"></i></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo base_url(); ?>works">New Work</a></li>
                        <li><a href="<?php echo base_url(); ?>works/contract_work">Contract Work</a></li>
                        <li><a href="<?php echo base_url(); ?>works/new_rental">New Retal</a></li>
                        <li><a href="<?php echo base_url(); ?>works/change_rental">Change Rental Client</a></li>
                    </ul>
                </li>
                <li><a href="<?php echo base_url(); ?>offers"><i class="fa fa-list-ol"></i> <span>Offers</span> </a></li>
                <li><a href="<?php echo base_url(); ?>projects"><i class="fa fa-tasks"></i> <span>Projects</span> </a> </li>
                <li><a href="<?php echo base_url(); ?>acceptance"><i class="fa fa-table"></i> <span>Acceptance</span></a></li>
                <li><a href="<?php echo base_url(); ?>reports"><i class="fa fa-bar-chart-o"></i> <span>Reports</span></a></li>
                <li><a href="<?php echo base_url(); ?>followup"><i class="fa fa-map-marker"></i> <span>Follow up</span></a></li>
                <li><a href="<?php echo base_url(); ?>clients"><i class="fa fa-sitemap"></i> <span>Clients</span></a></li>
                <li><a href="<?php echo base_url(); ?>sub_contractors"><i class="fa fa-calendar"></i> <span>Subcontractors</span></a></li>
                
                <li><a href="<?php echo base_url(); ?>workers"><i class="fa fa-user"></i> <span>Workers</span></a></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle='dropdown'><i class="fa fa-th"></i> <span>Labor<i class="fa fa-angle-down"></i></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo base_url(); ?>labours">My task list</a></li>
                        <li><a href="<?php echo base_url(); ?>labours/timesheet">Timesheet</a></li>
                    </ul>
                </li>
                <li><a href="#"><i class="fa fa-briefcase"></i> <span>Managment</span></a></li>
    ...
    <div id="page-container">
        ...
        <div id="page-rightbar">
            ...
            <div id="chatarea">
                ...
                <div class="chathistory" tabindex="5001" style="overflow-y: hidden; outline: none;">
                    <div class="chatmsg">
            ...
            <div id="widgetarea" tabindex="5000" style="max-height: 351px; overflow-y: hidden; outline: none;">
                <div class="widget">
                    ...
                    <div class="widget-body collapse in" id="accsummary">
                        <div class="widget-block" style="background: #7ccc2e; margin-top:10px;">
                            ...
                            <div class="pull-right"><div id="currentbalance"><canvas width="95" height="45" style="display: inline-block; width: 95px; height: 45px; vertical-align: top;"></canvas></div></div>
                        </div>
